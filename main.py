...
async def send_whatsapp_message(to_number: str, message: str):
    # This function does not need to change, as it now uses the
    # lifespan-managed httpx_client.
...
# ... (root and verify_webhook routes are the same) ...
@app.get("/")
def read_root():
...
# Webhook Event Handler (POST) - This is already robust from our last change
@app.post("/webhook")
